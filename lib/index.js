 ...
 * @requires king/lib/validation/api
 * @requires king/lib/validation/consumer
 * @requires king/lib/validation/plugin
 */

var Class             = require( 'prime' )             // simple class helper
  , url               = require('url')                 // node url module
  , util              = require('util')               // node util module
  , debug             = require('debug')('king:main')
 ...
 * @param {module:king~Api[]} [options.apis] an array of api configurations to be created or updated when the instance is created
 * @example var king = (new require('king')({
...
King = new Class({
     ...
     * @fires module:king#sync
     * @method module:king#sync
     * @return {Promise}
     **/
    ,sync:co.wrap(function* sync( ){
        ...
        /**
         * Fired after all configured consumers and apis /w associated plugins have be synced to the cluster
         * @name module:king#sync
         * @event
         **/
        this.emit('sync');
        return this;
    ...
    ,plugins: co.wrap(function*( id, data ){
        ...
        debug('no plugins loaded, creating all defined')
