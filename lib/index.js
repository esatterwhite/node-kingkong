 ...
 * @typedef {Object} module:kingkong~Api
 ...
 * @param {module:kingkong~Api|module:kingkong~Api[]} [options.apis] an array of api configurations to be created or updated when the instance is created
...
King = new Class({
     ...
     **/
    ,request:function _request( action, resource, id, data ){
        let result = resource_exp.exec( resource )
    ...
    ,sync:co.wrap(function* sync( ){
        ...
        /**
         * dispatched when all consumers, apis and their plugins have synced properly
