...
'use strict';
/**
 * Mixin for dealing with API objects in kong
 * @module king/lib/king/api
...
Api = new Class({
  /**
   * This does someKin
   * @method module:king/lib/king/api#create_api
   * @param {Object|Object[]} api Kong Api Definitions
   * @returns {Response[]} responses
   **/
